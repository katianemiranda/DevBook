...
// AtualizarUsuario - altera usuario
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível deletar um usuário que nao seja o seu"))
	}
	db, erro := banco.Conectar()
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	// Abre conexao ocm o banco de dados
	db, erro := banco.Conectar()
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
...
// BuscarSeguindo traz todos os sguidores de um usuário
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível alterar a senha que nao seja a sua"))
		return
	}

	corpoRequisicao, erro := ioutil.ReadAll(r.Body)
	/*	if erro != nil {
		respostas.Erro(w, ,erro)
		return
	}*/
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("A senha não condiz com a chave do banco"))
	}
