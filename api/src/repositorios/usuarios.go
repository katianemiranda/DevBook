...
// Buscar traz todos os usuarios que atendem um filtro de nomo ou nick
...
func (repositorio Usuarios) BuscarPorID(ID uint64) (modelos.Usuario, error) {
	...
	if erro != nil {
		return modelos.Usuario{}, erro // retona usuário vazio
	}
	defer linhas.Close()
...
// PararDeSeguir que o usuario pare de seguir o outro
...
// BuscarSeguindo traz usuarios segindo
...
// AtulizarSenha atualiza senha no cadastro do usuario
